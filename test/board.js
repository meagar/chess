...
describe('board', () => {
  ...
  describe('#eachSpace', () => {
    it('iterates over all the spaces, in order', () => {
      let spaces = 0, labels = '';
      getBoard().eachSpace((space, label) => { ++spaces; labels += label });

      assert.equal(spaces, 64);
      assert.equal(labels, 'a8b8c8d8e8f8g8h8a7b7c7d7e7f7g7h7a6b6c6d6e6f6g6h6a5b5c5d5e5f5g5h5a4b4c4d4e4f4g4h4a3b3c3d3e3f3g3h3a2b2c2d2e2f2g2h2a1b1c1d1e1f1g1h1');
    });
  });
